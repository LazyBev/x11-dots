...
makepkg -si 
cd ~ 
yay -S man i3 vesktop-bin wine mercury-browser-bin flameshot picom zip unzip fcitx5-mozc adobe-source-han-sans-jp-fonts adobe-source-han-serif-jp-fonts neofetch fcitx5-im lolcat polkit gvfs alsa-utils pipewire pipewire-pulse pavucontrol dunst xarchiver thunar thunar-archive-plugin lxappearance eza rofi fish bottom neovim nitrogen alacritty 
...
gitdot 
cd ~
read -p "Reboot in order for changes to take place..."  
